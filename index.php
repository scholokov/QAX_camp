		...
		<section id="content">
							...
							<div id="cources-cards-block" class="row col-mb-50 mb-1">
								...
								<!--
									<div class="col-lg-4">
										<div class="cources-qa-block">
											<a href="cources.html">
												<div class="cources-qa-block-title">Quality Assurance Engineer</div>
												<div class="line my-4"></div>

												<div class="cources-qa-text">
													Вмієш критично мислити? Помічаєш багато недоліків у програмах чи
													пристроях у повсякденному
													житті? Знаєш що можна було б зробити краще? У тебе є хист до QA! QA
													Engineer – людина що має
													право критикувати будь що на проекті.
													Наші фахівці розробили програму що поєднує поглиблене опрацьовування
													теоретичного матеріалу та
													практичні заняття, аби критика та ідеї QA були професійними,
													влучними,
													обґрунтованими та коректно оформленими.
												</div>
												<div id="cources-cards-buttons" class="d-flex bd-highlight mb-3">
													<div class="mr-auto p-2 bd-highlight cources-qa-cources-number">
														<a href="cources.html">
															1 Курс
														</a>
													</div>
													<div class="p-2 cources-qa-details">
														<a href="cources.html">
															Переглянути
														</a>
													</div>
			...
			<section id="cources">
				<div class="cources-block">
					...
					<div class="cources-title">
						Обери професію майбутнього
					</div>
					<a href="cources.html">
						<div class="cources-qa-block">
							<div class="cources-qa-block-title">Quality Assurance Engineer</div>
							<div class="cources-qa-block-line"></div>
							<div class="cources-qa-text">
								Вмієш критично мислити? Помічаєш багато недоліків у програмах чи пристроях у
								повсякденному
								житті? Знаєш що можна було б зробити краще? У тебе є хист до QA! QA Engineer – людина що
								має
								право критикувати будь що на проекті.
								Наші фахівці розробили програму що поєднує поглиблене опрацьовування теоретичного
								матеріалу
								та
								практичні заняття, аби критика та ідеї QA були професійними, влучними, обґрунтованими та
								коректно оформленими.
							</div>

							<div>
								<a href="cources.html" class="cources-qa-cources-number">
									1 Курс
								</a>
							</div>
							<div>
								<a href="cources.html" class="cources-qa-details">
									переглянути
								</a>
							</div>
						</div>
			...
			-->
					...
					<!--   <div class="cources-qa-details-arrow"></div>  -->



					<!--
				<div class="cources-ba-block"></div>
				<div class="cources-ba-block-title">Business Analyst</div>
				<div class="cources-ba-block-line">
					<div class="cources-ba-text">
						Підготовка молодих спеціалістів QA (тестерів) по такому напрямку,
						як:
						"Забезпечення Якості Програмного Забезпечення". Нашими фахівцями була розроблена збалансована
						програма, де поєднуються поглиблене опрацьовування теоретичного матеріалу і практичні заняття.
					</div>

				</div>
				<div class="cources-ba-cources-number">1 Курс</div>
				<div class="cources-ba-details">переглянути</div>
				<div class="cources-ba-details-arrow"></div>



				<div class="cources-pm-block"></div>
				<div class="cources-pm-block-title">Project Manager</div>
				<div class="cources-pm-block-line">
					<div class="cources-pm-text">
						PM несе відповідальність за все, що відбувається в роботі над проектом, і розв’язує проблеми,
						які виникають щодня. Він мусить уміти застосовувати основні принципи управління в роботі з
						вимогами та бюджетом, контролювати якість продукту, а також забезпечувати зворотній зв’язок між
						командою та замовником.
					</div>

				</div>
				<div class="cources-pm-cources-number">1 Курс</div>
				<div class="cources-pm-details">переглянути</div>
				<div class="cources-pm-details-arrow"></div>
			</section>
			-->
