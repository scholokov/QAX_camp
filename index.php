				...
				<div id="mobile-menu-fullscreen">
					...
					<div id="heroImage-block">
						...
						<div id="hero-text-block">
							...
							<a href="/courses.php?course=qa&name=qa_practice" id="hero-button">Дізнатися більше</a>
						</div>
					...
					<section id="start">
						...
						<div id="start-block" >
							...
							<div id="start-text-block">
								...
								<h4 id="start-text">Раді вітати тебе у нашому наметовому містечку.
								Тут ти зможеш здобути новітні знання в сфері IT, знайти нових друзів , 
								отримати безцінний досвід та набагато швидше знайти роботу своєї мрії. 
								</h4>
							</div>
						</div>
						...
						<div id="road-block" >
							...
							<div id="road-text-block">
								...
								<div id="road-text">
									...
									<p class="road-p">
									Курси, що дадуть тобі теоритичну базу по обраному напряму, для впевненого страту в ІТ та переходу до практики. 
									</p>
									<h4 class="road-small-title">Практичні курси</h4>
									<p class="road-p"> 
									Поринути в розробку програмного забезпечення, побачити як "це все" працює зсередини. Застосувати теоретичні знання та отримати досвід. 
									</p>
								</div>
							</div>
					...
					<section id="finish">
						...
						<div id="finish-block" >
							...
							<div id="finish-text-block">
								...
								<h4 id="finish-text">
								Наш успіх - це твій офер! Ми докладаємо максимальних зусиль, аби ти отримав найкращі знання у сфері ІТ та міг випробувати їх у майбутній роботі.
								</h4>
					...
					<section id="success-stories">
						...
						<div id="success-stories-block" >
							...
							<div id="success-stories-text-block">
								...
								<a href="courses.php?course=qa&name=qa_practice#comments-course-main-block" >Відгуки</a>
