                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">
                                                                <ul>
                                                                    ...
                                                                    <i>Домашнє завдання: пройти тест.</i>
                            ...
                            <div class="course-step">
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step"><ul>
                                                                    ...
                                                                    Завантажити Postman.<br>
                                                                    Протестувати метод GET.<br>
                                                                    Протестувати DELETE метод.</i>
                                                                </div>
                                       <a href="" class="spoiler_links">Читати повністю</a>
                                    <div class="spoiler_body">
                                    <ul>
                                    ...
                                    <div class="descriotion-step">– Розглянемо формати body.
                                        <ul>
                                         ...
                                         Показую як тестувати POST – запити.
                                            ...
                                            Протестувати метод на well-formed json.<br> 
                                            Протестувати метод використовуючи form - data та json.<br> 
                                            Протестувати метод із додаванням автарки використовуючи техніки тест-дизайну.</i>
                                    </div>
                                        <a href="" class="spoiler_links">Читати повністю</a>
                                    <div class="spoiler_body">
                                    <ul>
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">
                                       ...
                                       Практика: підвантажимо колекцію Trello. Створимо для неї оточення зі змінними. Заранимо колекцію.<br>
                                         ...
                                         <i>Домашнє завдання: зробити свою колекцію, додати змінні та оточення. Заранити колекцію.</i>
                                    </div>
											<a href="" class="spoiler_links">Читати повністю</a>
										<div class="spoiler_body">
                                        <ul>
                            ...
                            <div class="course-step">
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">
                                        ...
                                        <i>Домашнє завдання: все перелічене вище.</i>
                                    </div>
                                    <a href="" class="spoiler_links">Читати повністю</a>
										<div class="spoiler_body">
                                        <ul> 
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">
                                        <ul>
                                            ...
                                            Практика: все перелічене вище.<br>
                                            <i>Домашнє завдання: повторити за прикладом відео.<br>
                                            Склаcти чек-лист із тестування API.</i>
