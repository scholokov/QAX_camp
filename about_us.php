		...
		<section id="content">
			<div class="content-wrap">
				<div class="about_us_main_block container clearfix">
					...
					<div class="about_us_italic">Томас Едісон зробив більш ніж 1000 невдалих спроб, перед тим як винайти лампочку розжарювання</div>
					<div class="about_us_line"></div>
					...
					<div class="about_us_text">Ми розробляємо проєкти! 
					...
					<div class="about_us_line"></div>
					<div class="about_us_italic">Наша ДНК  -  це практика</div>
					<div class="about_us_line"></div>
					...
					<div class="about_us_text">Camp виник як рішення на одвічне питання: 
						“як потрапити на роботу, якщо на неї беруть тільки людей з досвідом?”.
					</div>
					<div class="about_us_text">Ще працюючи QA тренером в різних школах, засновник Camp, Денис Щолоков, вже тоді відчував, 
						що всі ці курси підготовки це завжди якась теорія, яким не вистачало чогось важливого…
					</div>
					<div class="about_us_text">З іншої сторони, Денис постійно отримував скарги від студентів, що навіть по закінченню курсів їм складно знайти працевлаштування, 
						бо “в них немає досвіду”... Так і народився QAX Camp! 
					</div>
					<div class="about_us_text">У Camp неважливий твій початок (хтось вже з базою, інший - відкриває все з нуля), 
					...
					<div class="about_us_text">1. Кількість отриманих оферів нашими учасниками<br>
