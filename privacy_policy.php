		...
		<section id="content">
			<div class="content-wrap" id="privacy_policy">
				<div class="privacy_policy_main_block container clearfix">
					...
					що визначені нижче:</li>

									<ol type="a">
											<li>персональна інформація буде видалена одразу після закінчення курсу;

											</li>
									</ol>

							<li> Незважаючи на інші положення Розділу V, ми будемо зберігати 
					документи (включаючи електронні   документи), які містять персональну інформацію:</li>
