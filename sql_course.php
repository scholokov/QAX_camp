	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap">
						...
						<div id="course-plan-steps">
                            ...
                            <div class="course-step">
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">Дізнаємось за допомогою яких операторів ми зможемо відсортувати дані 
										або згрупувати за якимись ознаками. Розберемо приклади та потренуємось на задачках.</div>
                                       <!-- <a href="" class="spoiler_links">Читати повністю</a>
                                    <div class="spoiler_body">
                                        <ol>
                            ...
                            <div class="course-step">
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">Поговоримо про те, як нам знайти дані в різних табличках і 
										відобразити результат запиту в одному місці. Дізнаємось які бувають JOIN-ни і що це практично 
										означає. Також, подивимось приклади їх використання і задачі для самоконтролю.</div>
                                        <!--<a href="" class="spoiler_links">Читати повністю</a>
                                    <div class="spoiler_body">
                                        <ol>
							...
							<div class="img-step"><img src="images/lesson5.svg" alt="step"></div>
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">Дізнаємось що таке вкладені запити, коли їх використовують і
										 подивимось на прикладах як їх робити. Розбремо задачі для самоконтролю. </div>
											<!--<a href="" class="spoiler_links">Читати повністю</a>
										<div class="spoiler_body">
                            ...
                            <div class="course-step">
                                ...
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">
                                        <p>Обговоримо, що ще ми можемо робити у БД, як додавати дані, як їх обновляти,
               ...
               <iframe name="iframe1" id="iframe1" src="https://forms.monday.com/forms/embed/69b9a1562e54e5c9222bb5c4b3bf902a?r=use1"  style="min-height: 2150px; height: 100%; border: 0; margin-bottom: -10px;"></iframe>
			</div>
		</section>
