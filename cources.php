												...
												<div class="accordion__item">
													...
													<div class="accordion__answer">
														<ul class="sub-menu tab active">
															<li class="menu-sub-item-QA" ><a href='#QA_automation' id='qa-course-link'
																	onclick="openTab(event, 'qa_automation')"
																	class="tablinks active">Автоматизація</a>
															</li>

															<li class="menu-sub-item-QA" ><a href='#QA_theory'
																	onclick="openTab(event, 'qa_theory')"
																	class="tablinks">Менторство</a>
															</li>
															<li class="menu-sub-item-QA" ><a href='#QA_practice'
																	onclick="openTab(event, 'qa_practice')"
													...
													<div class="accordion__answer">
														<ul class="sub-menu tab">
															...
															<li class="menu-sub-item-QA" ><a href='#pm_practice'
																	onclick="openTab(event, 'pm_practice')"
																	class="tablinks">Практика</a>
															</li>
