		...
		<section id="content">
			<div class="content-wrap">
					...
					<div id="new-course-start-block">
						<div id="new-course-main-text">
							...
							<div class="new-course-main-description">Друзі!<br>
                                ...
                                програмного забезпечення, та перейти до практичних занять з тестування.
                            </div>
						</div>
              ...
              <div class="linkedin-logo">
               ...
               <iframe name="iframe1" id="iframe1" src="https://forms.monday.com/forms/embed/7907437eb478113f6d5159033607ed0e?r=use1"  style="min-height: 2100px; max-height: 2350px; height: 100%; border: 0; margin-bottom: -10px;"></iframe>
			</div>
		</section>
