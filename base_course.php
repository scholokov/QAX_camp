						...
						<div id="new-course-main-text">
							...
							<div class="new-course-main-description">Друзі!<br>
                                ...
                                <ul>
                                    ...
                                    <li>які існують ролі в проєктних командах.</li>
                                </ul>

                                
                                І ще багато цікавого.<br>
                                Після проходження курсу “Теорія QA“ ви зможете повністю зрозуміти з
                                 чого складається напрям тестування програмного 
                                забезпечення та перейти до практичних занять з тестування. 
                            </div>
						</div>
							...
							<div class="img-step"><img src="images/lesson5.svg" alt="step"></div>
                                <div class="text-step">
                                    ...
                                    <div class="descriotion-step">Обговоримо для чого потрібна тестова документація, 
                                        дізнаємось що таке тест-кейс, які його особливості, яка структура тест-кейсу. Також, поговоримо про чеклісти, 
                                        коли варто їх використовувати, в чому різниця чеклістів та тест-кейсів.</div>
											<!--<a href="" class="spoiler_links">Читати повністю</a>
										<div class="spoiler_body">
